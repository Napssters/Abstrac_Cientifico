...
class SumaFrecuenciaView(QtWidgets.QDialog):
    def __init__(self):
        super(SumaFrecuenciaView, self).__init__()
        uic.loadUi('Views/QtViews/SumaFrecuencia_Window.ui', self)
        ...
        self.ver.clicked.connect(self.getSumaFrecuencia)
        self.step = ""
        self._isClose = False
        self.menu = False

    def getSumaFrecuencia(self):
        stops = "\""
        stops += str(self.step)
        stops += "\""
